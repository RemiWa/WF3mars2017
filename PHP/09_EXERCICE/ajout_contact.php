...
if(!empty($_POST)){
	...
	// Alternative:
	// if ($_post['type_contact'] !='ami' && $_POST[type_contact'] != 'profeesionnel' && ...)
	...
	if (empty($contenu)) {
		...
		{
			$_POST[$indice] = htmlspecialchars($valeur, ENT_QUOTES); // securité pour l'injection de caracteres speciaux'
		}
